...
public static class MemgraphService
{
    ...
    public static async Task SaveCategoriesRelationsAsync()
    {
        ...
        await Console.Out.WriteLineAsync("Categories Relations inserted to Memgraph");
    }
    ...
    public static async Task SavePopularityAsync()
    {
        ...
        await Task.Delay(0);
        await Console.Out.WriteLineAsync("Popularises inserted to Memgraph");
    }
    ...
    public static async Task SavePopularityRelationsAsync()
    {
        ...
        await Task.Delay(0);
        await Console.Out.WriteLineAsync("Popularises Relations inserted to Memgraph");
    }
}